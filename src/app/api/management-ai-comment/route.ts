        ...
        messages: [
          {
            ...
            content: [
              ...
              "最初に currentScale, futureScale, mainGoal, decisionStage から、店の規模感と目指す方向を推定してください。",
              "夫婦2人の小規模店、スタッフありの地域店、複数店舗志向、通販拡大志向など、規模感によって質問と施策の優先順位を変えてください。",
              ...
              "入力された現状規模、将来規模、目標、判断段階、目的、しんどさ、制約、強み、顧客価値、役割バランス、理想の働き方、負担の大きい商品、守りたい品質、地域の支持者、小さな実験案を必ず踏まえてください。",
              ...
              "summaryでは、推定した店の規模感、目標、数字から見えること、数字だけでは判断しない前提を短く述べてください。",
              "diagnosis_commentでは、回答内容から見える大切にしたい価値、本当の制約、既存の強み、現時点での仮説を整理してください。",
              "fit_actionsでは、この店の規模感・価値観・制約に合いそうな施策を3つ以内で返してください。",
