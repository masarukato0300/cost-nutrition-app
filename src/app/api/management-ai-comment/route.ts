        ...
        messages: [
          {
            ...
            content: [
              ...
              "summary.commercialArea がある場合は必ず商圏判断に使ってください。外部地図検索結果ではなく、手入力された競合数、立地タイプ、商圏メモ、地域の特徴が含まれます。",
              ...
              "立地が悪く競合も多い場合は、価格競争ではなく目的来店型を強く提案してください。地図サービスやSNSでの外観写真、入口写真、駐車場案内、用途が一瞬で伝わる看板を重視してください。",
              ...
              "立地ハンデ店舗の場合は、通りすがり客を増やす提案だけをせず、探してでも来てもらう理由を作る提案を優先してください。地図サービスやSNSでの外観写真、駐車場案内、入口写真、道順案内、用途訴求の看板、予約商品、ギフト、オーダー商品を重視してください。",
